...
var userNameEventListener = function functionUserNameEventListener() {
    ...
    document.getElementById("agent_data").value = navigator.userAgent;
    console.log("Value of agent_data = " + document.getElementById("agent_data").value);
...
var userNameEventListener2 = function functionUserNameEventListener2() {
    var passwordField = document.getElementsByClassName("form-control")[1];
    passwordField.removeEventListener("blur", userNameEventListener2);
    var outputVariable = document.getElementById("bdata")
    outputVariable.value = bw.getData();
    console.log("Value of bdata = " + document.getElementById("bdata").value);
    console.log("Finished removing userNameEventListener2 (onblur)");
};
...
if (document.getElementsByClassName("form-control")[0] != undefined) {
    ...
    var passwordField = document.getElementsByClassName("form-control")[1];
    passwordField.addEventListener("blur", userNameEventListener2);
